  					...
  					<el-card>
  						<el-tabs v-model="activeName3" type="card" @tab-click="handleClick3" >
  						    <!-- <el-tab-pane label="用户发布占比" name="tb001" >
  								<div id="articleUserReport"  style="height: 506px;"></div>
  						    </el-tab-pane> -->
  						    <el-tab-pane label="项目文章占比" name="tb001">
  								<div id="articleProject" ref="pieEcharts3" style="height: 506px;"></div>
  						    </el-tab-pane>
  ...
  　　　　　　　//计算完之后必须清除，否则选择器一直处于禁止选择的状态
    ...
    methods: {
      ...
      articleUserReport () {
      	let _this = this
      	// 基于准备好的dom，初始化echarts实例
      	let myChart = this.$echarts.init(document.getElementById('articleUserReport'),'walden')
      	// 绘制图表
      ...
      articleProject () {
      	let _this = this
      	// 基于准备好的dom，初始化echarts实例
      	let myChart = this.$echarts.init(document.getElementById('articleProject'),'walden')
      	// 绘制图表
      ...
      articleType1 () {
      	let _this = this
      	// 基于准备好的dom，初始化echarts实例
      	let myChart = this.$echarts.init(document.getElementById('articleType1'),'walden')
      	// 绘制图表
      ...
      articleType2 () {
      	let _this = this
      	// 基于准备好的dom，初始化echarts实例
      	let myChart = this.$echarts.init(document.getElementById('articleType2'),'walden')
      	// 绘制图表
      ...
      articleUserType1 () {
      	let _this = this
      	// 基于准备好的dom，初始化echarts实例
      	let myChart = this.$echarts.init(document.getElementById('articleUserType1'),'walden')
      	// 绘制图表
      ...
      articleUserType2 () {
      	let _this = this
      	// 基于准备好的dom，初始化echarts实例
      	let myChart = this.$echarts.init(document.getElementById('articleUserType2'),'walden')
      	// 绘制图表
      ...
      articleTypeProjectAll () {
      	let _this = this
      	// 基于准备好的dom，初始化echarts实例
      	let myChart = this.$echarts.init(document.getElementById('articleTypeProjectAll'),'walden')
      	// 绘制图表
      ...
      articleTypeProjectMonthAll () {
      	let _this = this
      	// 基于准备好的dom，初始化echarts实例
      	let myChart = this.$echarts.init(document.getElementById('articleTypeProjectMonthAll'),'walden')
      	// 绘制图表
      ...
      activeProjectUserAll () {
      	let _this = this
      	// 基于准备好的dom，初始化echarts实例
      	let myChart = this.$echarts.init(document.getElementById('activeProjectUserAll'),'walden')
      	// 绘制图表
      ...
      activeProjectUserMonthAll () {
      	let _this = this
      	// 基于准备好的dom，初始化echarts实例
      	let myChart = this.$echarts.init(document.getElementById('activeProjectUserMonthAll'),'walden')
      	// 绘制图表
      ...
      userBrowseWebInfo () {
      	let _this = this
      	// 基于准备好的dom，初始化echarts实例
      	let myChart = this.$echarts.init(document.getElementById('userBrowseWebInfo'),'walden')
        myChart.clear()
      	// 绘制图表
      ...
      articleWeek() {
      	let _this = this
      		// 基于准备好的dom，初始化echarts实例
            let myChart = this.$echarts.init(document.getElementById('articleWeek'),'walden')
            // 绘制图表
            myChart.setOption({
                title: {
                  text: '一周发布',
